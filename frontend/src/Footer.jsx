...
const Footer = () => {
  return (
    <div className="Footer flex space__around pz__15" style={{"borderTop":".10px solid rgba(21,21,21,0.5)"}}>
      {/* Footer 1st part */}
      <div className="footer1st" style={{marginLeft:"10px", paddingTop:"20px"}}>
        ...
        <strong style={{
          ...
          cursor:"text",
          color:"black",
        }}>CÔNG TY TNHH KIANA VIETNAM</strong>
        </div>
        <div className="location flex py__10">
          ...
          <h6>235, Quỳnh Hồng ,Quỳnh Lưu ,Nghệ An </h6>
        </div>
      ...
      <div className="mobile">
        <div className="footer__2nd__part" style={{
          fontFamily:"Oswald",
        }}>
             <h5>Tài Khoản</h5>
      ...
      {/* Footer 4th part */}
       <div className="footer__3rd__part" style={{
          fontFamily:"Oswald",
        }}>
            <h5>Dịch vụ</h5>
      ...
      {/* Footer 5th part */}
      <div className="footer__4th__part" style={{
          fontFamily:"Oswald",
        }}>
      <h5>Rules</h5>
